...
export const metadata: Metadata = {
  title: "AI Agents for Veterinary Practices: Automate Appointments & Patient Care | UK Veterinary AI",
      ...
      <section className="bg-light py-16">
        <div className="max-w-[1140px] mx-auto px-6 text-center">
          ...
          <p className="text-muted max-w-[600px] mx-auto text-sm">
            Phil Patterson helps UK veterinary practices implement AI automation from his base in Derry, Northern Ireland. 
