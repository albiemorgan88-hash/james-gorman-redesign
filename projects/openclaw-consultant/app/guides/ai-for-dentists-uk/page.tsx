          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <div className="text-center">
                ...
                <div className="text-muted-dark text-sm">No-show reduction</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-muted-dark text-sm">Admin time saved weekly</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-muted-dark text-sm">Annual revenue recovered</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-muted-dark text-sm">Online booking available</div>
              </div>
            </div>
          ...
          <section className="mb-16">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-blue/5 to-green-500/5 rounded-xl p-6 border border-blue/10">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-semibold text-dark mb-2 text-sm">Automated Messages:</h4>
                    <ul className="space-y-1 text-muted-dark text-xs">
                  ...
                  <div>
                    <h4 className="font-semibold text-dark mb-2 text-sm">AI Chatbot Capabilities:</h4>
                    <ul className="space-y-1 text-muted-dark text-xs">
              ...
              <div className="bg-gradient-to-r from-green-500/5 to-purple/5 rounded-xl p-6 border border-green-500/10">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-semibold text-dark mb-2 text-sm">Clinical AI Tools:</h4>
                    <ul className="space-y-1 text-muted-dark text-xs">
                  ...
                  <div>
                    <h4 className="font-semibold text-dark mb-2 text-sm">Admin Efficiency:</h4>
                    <ul className="space-y-1 text-muted-dark text-xs">
              ...
              <div className="bg-gradient-to-r from-purple/5 to-orange/5 rounded-xl p-6 border border-purple/10">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-semibold text-dark mb-2 text-sm">Revenue Growth:</h4>
                    <ul className="space-y-1 text-muted-dark text-xs">
                  ...
                  <div>
                    <h4 className="font-semibold text-dark mb-2 text-sm">Local SEO and Marketing:</h4>
                    <ul className="space-y-1 text-muted-dark text-xs">
          ...
          <section className="mb-16">
            ...
            <div className="bg-gradient-to-br from-orange/5 to-blue/5 rounded-xl p-8 border border-orange/10">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h4 className="font-semibold text-dark mb-3">NHS Practices:</h4>
                ...
                <div>
                  <h4 className="font-semibold text-dark mb-3">Private Practices:</h4>
                  <ul className="space-y-2 text-muted-dark text-sm">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="border-l-4 border-orange pl-4">
                      <h4 className="font-medium text-dark mb-1">AI Strategy for Dental</h4>
                      <p className="text-muted-dark text-sm"><a href="https://bluecanvas.ai" className="text-orange hover:text-orange-hover">Blue Canvas</a> helps dental practices implement AI automation that integrates with existing practice management software.</p>
                    </div>
                    <div className="border-l-4 border-blue pl-4">
                      <h4 className="font-medium text-dark mb-1">WhatsApp Automation</h4>
                      <p className="text-muted-dark text-sm">Connect with patients on their preferred channel using <a href="https://heypinchy.com" className="text-orange hover:text-orange-hover">Pinchy</a> workflow automation.</p>
                    </div>
                    <div className="border-l-4 border-green-500 pl-4">
                      <h4 className="font-medium text-dark mb-1">Data Protection</h4>
                      <p className="text-muted-dark text-sm">All AI implementations must comply with GDPR, NHS data standards, and GDC record-keeping requirements.</p>
                    </div>
                  </div>
                </div>
              </div>
