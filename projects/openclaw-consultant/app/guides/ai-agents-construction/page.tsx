...
export const metadata: Metadata = {
  title: "AI Agents for Construction Companies: Automate Project Management & Estimating | UK Construction AI",
      ...
      <section className="bg-light py-16">
        <div className="max-w-[1140px] mx-auto px-6 text-center">
          ...
          <p className="text-muted max-w-[600px] mx-auto text-sm">
            Phil Patterson helps UK construction companies implement AI automation from his base in Derry, Northern Ireland. 
