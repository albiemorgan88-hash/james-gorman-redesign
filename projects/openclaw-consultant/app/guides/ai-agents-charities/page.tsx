      ...
      <section className="bg-light py-16">
        <div className="max-w-[1140px] mx-auto px-6 text-center">
          ...
          <p className="text-muted max-w-[600px] mx-auto text-sm">
            Phil Patterson helps UK charities and nonprofit organizations implement AI automation from his base in Derry, Northern Ireland. 
      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-[1140px] mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-[800px] mx-auto">
            ...
            <a href="/guides/ai-agents-construction" className="group bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all hover:-translate-y-1 border border-slate-100">
