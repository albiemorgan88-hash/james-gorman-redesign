          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <div className="text-center">
                ...
                <div className="text-muted-dark text-sm">Waste reduction with AI</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-muted-dark text-sm">Fewer stockouts</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-muted-dark text-sm">Working capital freed</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-muted-dark text-sm">Forecast accuracy</div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-r from-orange/5 to-blue/5 rounded-xl p-6 border border-orange/10">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-semibold text-dark mb-2 text-sm">Signals Analysed:</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-dark mb-2 text-sm">Industry Applications:</h4>
                    <ul className="space-y-1 text-muted-dark text-xs">
              ...
              <div className="bg-gradient-to-r from-blue/5 to-green-500/5 rounded-xl p-6 border border-blue/10">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-semibold text-dark mb-2 text-sm">Smart Reordering:</h4>
                    <ul className="space-y-1 text-muted-dark text-xs">
                  ...
                  <div>
                    <h4 className="font-semibold text-dark mb-2 text-sm">Cost Optimisation:</h4>
                    <ul className="space-y-1 text-muted-dark text-xs">
              ...
              <div className="bg-gradient-to-r from-green-500/5 to-purple/5 rounded-xl p-6 border border-green-500/10">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-semibold text-dark mb-2 text-sm">Waste Reduction:</h4>
                    <ul className="space-y-1 text-muted-dark text-xs">
                  ...
                  <div>
                    <h4 className="font-semibold text-dark mb-2 text-sm">Reporting:</h4>
                    <ul className="space-y-1 text-muted-dark text-xs">
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b">
                      <th className="text-left py-3 font-medium text-dark">Business Size</th>
