...
export default function OpenClawSetupWindowsPage() {
  return (
    <>
        ...
        <div className="max-w-[1140px] mx-auto px-6 relative z-10 py-20">
          <div className="max-w-[720px]">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="#methods" className="inline-flex items-center justify-center bg-orange text-white px-8 py-4 rounded-xl font-semibold text-base hover:bg-orange-hover transition-all hover:-translate-y-0.5 shadow-glow-orange">
      ...
      <section id="prerequisites" className="bg-white py-28">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-2">
                      <div className="bg-slate-900 text-green-400 p-3 rounded-md font-mono text-sm">
                        <span className="text-muted"># Check if installed (PowerShell):</span><br/>
                      ...
                      {prereq.installCommand && (
                        <div className="bg-slate-900 text-green-400 p-3 rounded-md font-mono text-sm">
                          <span className="text-muted"># Install command:</span><br/>
      ...
      <section id="powershell-method" className="bg-white py-28">
        <div className="max-w-[1140px] mx-auto px-6">
          <div className="text-center mb-14">
            <h2 className="font-heading text-3xl md:text-4xl font-bold text-dark mb-4">
      ...
      <section className="py-16 bg-surface">
        <div className="max-w-[1140px] mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-[800px] mx-auto">
            ...
            <a href="/guides/openclaw-setup-telegram" className="group bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all hover:-translate-y-1 border border-border-light">
