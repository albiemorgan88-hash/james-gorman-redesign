...
export const metadata: Metadata = {
  title: "AI for Schools: Wellbeing, Admin, and Student Support | OpenClaw",
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <div className="text-center">
                ...
                <div className="text-slate-600 text-sm">Saved per teacher weekly</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-slate-600 text-sm">Wellbeing issue detection</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-slate-600 text-sm">Reduction in admin tasks</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-slate-600 text-sm">Aligned evidence gathering</div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-r from-orange/5 to-blue/5 rounded-xl p-6 border border-orange/10">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-2 text-sm">How It Works:</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-2 text-sm">Impact:</h4>
                    <ul className="space-y-1 text-slate-600 text-xs">
              ...
              <div className="bg-gradient-to-r from-blue/5 to-green-500/5 rounded-xl p-6 border border-blue/10">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-2 text-sm">Tasks AI Can Handle:</h4>
                    <ul className="space-y-1 text-slate-600 text-xs">
                  ...
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-2 text-sm">Time Saved:</h4>
                    <ul className="space-y-1 text-slate-600 text-xs">
              ...
              <div className="bg-gradient-to-r from-green-500/5 to-purple/5 rounded-xl p-6 border border-green-500/10">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-2 text-sm">SEN Support:</h4>
                    <ul className="space-y-1 text-slate-600 text-xs">
                  ...
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-2 text-sm">SENCO Benefits:</h4>
                    <ul className="space-y-1 text-slate-600 text-xs">
              ...
              <div className="bg-gradient-to-r from-purple/5 to-orange/5 rounded-xl p-6 border border-purple/10">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-2 text-sm">Attendance AI:</h4>
                    <ul className="space-y-1 text-slate-600 text-xs">
                  ...
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-2 text-sm">Behaviour Management:</h4>
                    <ul className="space-y-1 text-slate-600 text-xs">
          ...
          <section className="mb-16">
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b">
                      <th className="text-left py-3 font-medium text-slate-800">AI Application</th>
            ...
            <div className="bg-gradient-to-br from-orange/5 to-blue/5 rounded-xl p-8 border border-orange/10">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h4 className="font-semibold text-slate-800 mb-3">Government and Trust Funding:</h4>
                ...
                <div>
                  <h4 className="font-semibold text-slate-800 mb-3">Cost Justification:</h4>
                  <ul className="space-y-2 text-slate-600 text-sm">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="border-l-4 border-orange pl-4">
                      <h4 className="font-medium text-slate-800 mb-1">AI Strategy for Schools</h4>
                      <p className="text-slate-600 text-sm"><a href="https://bluecanvas.ai" className="text-orange hover:text-orange-hover">Blue Canvas</a> helps schools and MATs implement AI that integrates with existing MIS platforms (SIMS, Arbor, Bromcom) and respects safeguarding requirements.</p>
                    </div>
                    <div className="border-l-4 border-blue pl-4">
                      <h4 className="font-medium text-slate-800 mb-1">Parent Communication</h4>
                      <p className="text-slate-600 text-sm">Automate parent communication workflows with <a href="https://heypinchy.com" className="text-orange hover:text-orange-hover">Pinchy</a> — absence notifications, event reminders, and report distribution via WhatsApp and email.</p>
                    </div>
                    <div className="border-l-4 border-green-500 pl-4">
                      <h4 className="font-medium text-slate-800 mb-1">Safeguarding First</h4>
                      <p className="text-slate-600 text-sm">All AI implementations must comply with KCSIE, DfE guidance on AI in education, and the UK GDPR Children&apos;s Code. Data stays within UK boundaries.</p>
                    </div>
                  </div>
                </div>
              </div>
