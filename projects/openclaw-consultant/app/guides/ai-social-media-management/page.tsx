...
export const metadata: Metadata = {
  title: "AI Social Media Management for UK Businesses | OpenClaw",
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <div className="text-center">
                ...
                <div className="text-slate-600 text-sm">UK SMEs use social media</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-slate-600 text-sm">Weekly time spent</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-slate-600 text-sm">Time saved with AI</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-slate-600 text-sm">Engagement uplift possible</div>
              </div>
            </div>
          </section>
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-r from-orange/5 to-blue/5 rounded-xl p-6 border border-orange/10">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-2 text-sm">What AI Generates:</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-2 text-sm">Keeping It Authentic:</h4>
                    <ul className="space-y-1 text-slate-600 text-xs">
              ...
              <div className="bg-gradient-to-r from-blue/5 to-green-500/5 rounded-xl p-6 border border-blue/10">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-2 text-sm">Smart Scheduling:</h4>
                    <ul className="space-y-1 text-slate-600 text-xs">
                  ...
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-2 text-sm">Popular UK Tools:</h4>
                    <ul className="space-y-1 text-slate-600 text-xs">
              ...
              <div className="bg-gradient-to-r from-green-500/5 to-purple/5 rounded-xl p-6 border border-green-500/10">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-2 text-sm">Automated Engagement:</h4>
                    <ul className="space-y-1 text-slate-600 text-xs">
                  ...
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-2 text-sm">Monitoring:</h4>
                    <ul className="space-y-1 text-slate-600 text-xs">
              ...
              <div className="bg-gradient-to-r from-purple/5 to-orange/5 rounded-xl p-6 border border-purple/10">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-2 text-sm">AI-Powered Insights:</h4>
                    <ul className="space-y-1 text-slate-600 text-xs">
                  ...
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-2 text-sm">Automated Reporting:</h4>
                    <ul className="space-y-1 text-slate-600 text-xs">
          ...
          <section className="mb-16">
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-red-500 pl-4 py-2">
                <h3 className="font-semibold text-slate-800 mb-1">Publishing AI content without editing</h3>
                <p className="text-slate-600 text-sm">Raw AI content is obvious and off-putting. Always add personal touches, real experiences, and your brand&apos;s unique voice. AI provides the structure; you provide the soul.</p>
              </div>
              <div className="border-l-4 border-red-500 pl-4 py-2">
                <h3 className="font-semibold text-slate-800 mb-1">Over-automating engagement</h3>
                <p className="text-slate-600 text-sm">Automated &quot;Thanks for sharing! 🙏&quot; replies fool nobody. Use AI for drafting responses, but personalise them. Genuine engagement beats automated volume every time.</p>
              </div>
              <div className="border-l-4 border-red-500 pl-4 py-2">
                <h3 className="font-semibold text-slate-800 mb-1">Ignoring platform differences</h3>
                <p className="text-slate-600 text-sm">Cross-posting identical content to LinkedIn, Instagram, and Facebook is lazy and ineffective. AI should adapt content for each platform&apos;s format, tone, and audience expectations.</p>
              </div>
              <div className="border-l-4 border-red-500 pl-4 py-2">
                <h3 className="font-semibold text-slate-800 mb-1">Chasing vanity metrics</h3>
                <p className="text-slate-600 text-sm">Likes and followers are nice. Revenue is better. Set up proper tracking to measure which social activity actually drives business outcomes — leads, bookings, sales.</p>
              </div>
            </div>
          </section>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b">
                      <th className="text-left py-3 font-medium text-slate-800">Approach</th>
