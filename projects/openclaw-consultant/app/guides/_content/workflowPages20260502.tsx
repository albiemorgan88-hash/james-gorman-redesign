...
const guides: Record<string, Guide> = {
  ...
  "openclaw-customer-onboarding": {
    ...
    relatedGuides: [{ href: "/guides/ai-customer-onboarding", title: "Automate Customer Onboarding with AI" }, { href: "/guides/openclaw-document-processing", title: "OpenClaw Document Processing" }, ...commonRelated.slice(0, 2)],
  ...
  "openclaw-invoice-processing": {
    ...
    relatedGuides: [{ href: "/guides/ai-invoice-processing", title: "AI Invoice Processing" }, { href: "/guides/openclaw-document-processing", title: "OpenClaw Document Processing" }, ...commonRelated.slice(1, 3)],
  ...
  "openclaw-reporting-automation": {
    ...
    relatedGuides: [{ href: "/guides/ai-reporting-automation-uk", title: "AI Reporting Automation UK" }, { href: "/guides/openclaw-operations-dashboard", title: "OpenClaw Operations Dashboard" }, ...commonRelated.slice(0, 2)],
