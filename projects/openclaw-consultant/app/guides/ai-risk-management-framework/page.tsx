              ...
              {riskCategories.map((category, i) => (
                <div key={i} className="bg-white rounded-xl p-6 shadow-lg border border-border-light">
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    <div>
                      <h4 className="font-semibold text-dark mb-3">Key Risks:</h4>
                    ...
                    <div>
                      <h4 className="font-semibold text-dark mb-3">Monitoring & KPIs:</h4>
                      <ul className="space-y-2">
            ...
            <div className="bg-gradient-to-br from-orange/5 to-blue/5 rounded-xl p-8 border border-orange/10 mb-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-dark mb-2">Risk Identification</h4>
                    <p className="text-muted-dark text-sm mb-3">Systematically identify potential risks across all AI system components, processes, and stakeholders.</p>
                    <div className="bg-white rounded-lg p-4 border border-border-light">
                      <div className="grid md:grid-cols-2 gap-4 text-sm">
                        <div>
                          <h5 className="font-medium text-dark mb-2">Methods:</h5>
                        ...
                        <div>
                          <h5 className="font-medium text-dark mb-2">Outputs:</h5>
                          <ul className="space-y-1 text-muted-dark">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-dark mb-2">Risk Analysis</h4>
                    <p className="text-muted-dark text-sm mb-3">Analyse the likelihood and impact of identified risks to understand their significance.</p>
                    <div className="bg-white rounded-lg p-4 border border-border-light">
                      <div className="grid md:grid-cols-2 gap-4 text-sm">
                        <div>
                          <h5 className="font-medium text-dark mb-2">Likelihood Factors:</h5>
                          <ul className="space-y-1 text-muted-dark">
                        ...
                        <div>
                          <h5 className="font-medium text-dark mb-2">Impact Dimensions:</h5>
                          <ul className="space-y-1 text-muted-dark">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-dark mb-2">Risk Evaluation</h4>
                    <p className="text-muted-dark text-sm mb-3">Evaluate risks against risk appetite and tolerance levels to prioritise management efforts.</p>
                    <div className="bg-white rounded-lg p-4 border border-border-light">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-dark mb-2">Risk Treatment</h4>
                    <p className="text-muted-dark text-sm mb-3">Develop and implement appropriate risk treatment strategies based on evaluation results.</p>
                    <div className="bg-white rounded-lg p-4 border border-border-light">
                      <div className="grid md:grid-cols-4 gap-3 text-sm">
                        <div className="text-center">
                          <h5 className="font-medium text-dark mb-1">Avoid</h5>
                          <p className="text-muted-dark text-xs">Eliminate the risk source</p>
                        </div>
                        <div className="text-center">
                          <h5 className="font-medium text-dark mb-1">Mitigate</h5>
                          <p className="text-muted-dark text-xs">Reduce likelihood/impact</p>
                        </div>
                        <div className="text-center">
                          <h5 className="font-medium text-dark mb-1">Transfer</h5>
                          <p className="text-muted-dark text-xs">Share with third parties</p>
                        </div>
                        <div className="text-center">
                          <h5 className="font-medium text-dark mb-1">Accept</h5>
                          <p className="text-muted-dark text-xs">Monitor within tolerance</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-dark mb-2">Monitoring & Review</h4>
                    <p className="text-muted-dark text-sm mb-3">Continuously monitor risk levels and review the effectiveness of risk management measures.</p>
                    <div className="bg-white rounded-lg p-4 border border-border-light">
                      <div className="grid md:grid-cols-2 gap-4 text-sm">
                        <div>
                          <h5 className="font-medium text-dark mb-2">Monitoring Activities:</h5>
                          <ul className="space-y-1 text-muted-dark">
                        ...
                        <div>
                          <h5 className="font-medium text-dark mb-2">Review Frequency:</h5>
                          <ul className="space-y-1 text-muted-dark">
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              <div className="bg-surface rounded-xl p-6 border border-border-light">
                ...
                <div className="space-y-4">
                  <div className="border-l-4 border-red-500 pl-4">
                    <h4 className="font-medium text-dark mb-1">Model Performance</h4>
                    <ul className="text-muted-dark text-sm space-y-1">
                  ...
                  <div className="border-l-4 border-blue pl-4">
                    <h4 className="font-medium text-dark mb-1">System Health</h4>
                    <ul className="text-muted-dark text-sm space-y-1">
              ...
              <div className="bg-surface rounded-xl p-6 border border-border-light">
                ...
                <div className="space-y-4">
                  <div className="bg-white rounded-lg p-4 border border-border-light">
                    <h4 className="font-medium text-dark mb-2">Executive Summary</h4>
                    <p className="text-muted-dark text-sm">High-level risk status, trends, and critical alerts for senior management</p>
                  </div>
                  <div className="bg-white rounded-lg p-4 border border-border-light">
                    <h4 className="font-medium text-dark mb-2">Risk Heat Map</h4>
                    <p className="text-muted-dark text-sm">Visual representation of risk likelihood vs. impact across all categories</p>
                  </div>
                  <div className="bg-white rounded-lg p-4 border border-border-light">
                    <h4 className="font-medium text-dark mb-2">Trend Analysis</h4>
                    <p className="text-muted-dark text-sm">Historical risk patterns, emerging trends, and predictive indicators</p>
                  </div>
                  <div className="bg-white rounded-lg p-4 border border-border-light">
                    <h4 className="font-medium text-dark mb-2">Action Tracking</h4>
                    <p className="text-muted-dark text-sm">Status of risk mitigation actions, owners, and completion timelines</p>
                  </div>
                </div>
              </div>
            </div>
