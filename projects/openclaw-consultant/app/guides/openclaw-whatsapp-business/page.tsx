...
export const metadata: Metadata = {
  title: "OpenClaw + WhatsApp Business: Automate Customer Chat | OpenClaw",
        ...
        <div className="max-w-[800px] mx-auto px-6">
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <div className="text-center">
                ...
                <div className="text-slate-600 text-sm">Message open rate</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-slate-600 text-sm">Instant responses</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-slate-600 text-sm">Higher than email engagement</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-slate-600 text-sm">Queries handled automatically</div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-r from-orange/5 to-blue/5 rounded-xl p-6 border border-orange/10">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-2 text-sm">Capabilities:</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-2 text-sm">Results:</h4>
                    <ul className="space-y-1 text-slate-600 text-xs">
              ...
              <div className="bg-gradient-to-r from-blue/5 to-green-500/5 rounded-xl p-6 border border-blue/10">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-2 text-sm">Booking Features:</h4>
                    <ul className="space-y-1 text-slate-600 text-xs">
              ...
              <div className="bg-gradient-to-r from-green-500/5 to-purple/5 rounded-xl p-6 border border-green-500/10">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-2 text-sm">Sales Automation:</h4>
                    <ul className="space-y-1 text-slate-600 text-xs">
              ...
              <div className="bg-gradient-to-r from-purple/5 to-orange/5 rounded-xl p-6 border border-purple/10">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-2 text-sm">Notification Types:</h4>
                    <ul className="space-y-1 text-slate-600 text-xs">
                  ...
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-2 text-sm">Customer Experience:</h4>
                    <ul className="space-y-1 text-slate-600 text-xs">
          ...
          <section className="mb-16">
            ...
            <div className="bg-gradient-to-r from-blue/5 to-green-500/5 rounded-xl p-6 border border-blue/10 mb-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-1">Get WhatsApp Business API Access</h4>
                    <p className="text-slate-600 text-sm">Register for the WhatsApp Business Platform through Meta. You&apos;ll need a verified business, a dedicated phone number, and a Facebook Business Manager account. This takes 1-3 days for approval.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-8 h-8 bg-orange rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  ...
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-1">Install and Configure OpenClaw</h4>
                    <p className="text-slate-600 text-sm">Set up OpenClaw on your Mac, Windows, or Linux machine. The WhatsApp channel plugin connects via the official API — no unofficial hacks or number banning risks.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-8 h-8 bg-orange rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  ...
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-1">Train Your AI Agent</h4>
                    <p className="text-slate-600 text-sm">Feed your agent your business knowledge: services, pricing, FAQs, booking rules, escalation policies. OpenClaw uses skills and memory to learn your business context — not generic responses.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-8 h-8 bg-orange rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  ...
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-1">Connect Integrations</h4>
                    <p className="text-slate-600 text-sm">Link your calendar, CRM, inventory, or booking system. Use <a href="https://heypinchy.com" className="text-orange hover:text-orange-hover">Pinchy</a> to automate workflows — when a booking is made on WhatsApp, it flows to your calendar, sends a confirmation, and updates your CRM automatically.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-8 h-8 bg-orange rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  ...
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-1">Test and Go Live</h4>
                    <p className="text-slate-600 text-sm">Run test conversations, refine responses, set up human escalation rules, and go live. Start with a soft launch — direct a percentage of enquiries to WhatsApp and monitor before going all-in.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-orange/5 to-blue/5 rounded-xl p-8 border border-orange/10">
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b">
                      <th className="text-left py-3 font-medium text-slate-800">Component</th>
              ...
              <p className="text-slate-500 text-xs mt-4">Compare this to hiring a part-time customer service rep at £1,200+/month — and the AI works 24/7, never calls in sick, and handles unlimited concurrent conversations.</p>
            </div>
          </section>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="border-l-4 border-orange pl-4">
                      <h4 className="font-medium text-slate-800 mb-1">Salons and Spas</h4>
                      <p className="text-slate-600 text-sm">Customers book treatments, reschedule, and ask about availability — all via WhatsApp. Automated reminders cut no-shows by 35%.</p>
                    </div>
                    <div className="border-l-4 border-blue pl-4">
                      <h4 className="font-medium text-slate-800 mb-1">Tradespeople</h4>
                      <p className="text-slate-600 text-sm">Capture job enquiries, provide instant quotes, and confirm bookings while you&apos;re on-site. Never miss a lead because you were under a sink.</p>
                    </div>
                    <div className="border-l-4 border-green-500 pl-4">
                      <h4 className="font-medium text-slate-800 mb-1">Healthcare Practices</h4>
                      <p className="text-slate-600 text-sm">Appointment booking, prescription reminders, and pre-appointment forms — all GDPR-compliant and secure.</p>
                    </div>
                  </div>
                </div>
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="border-l-4 border-orange pl-4">
                      <h4 className="font-medium text-slate-800 mb-1">Online Shops</h4>
                      <p className="text-slate-600 text-sm">Order status enquiries, returns processing, product recommendations, and abandoned cart recovery — all on WhatsApp.</p>
                    </div>
                    <div className="border-l-4 border-blue pl-4">
                      <h4 className="font-medium text-slate-800 mb-1">Restaurants and Takeaways</h4>
                      <p className="text-slate-600 text-sm">Table bookings, menu enquiries, and takeaway orders via WhatsApp. Integrates with your POS and kitchen display.</p>
                    </div>
                    <div className="border-l-4 border-green-500 pl-4">
                      <h4 className="font-medium text-slate-800 mb-1">Property and Lettings</h4>
                      <p className="text-slate-600 text-sm">Handle tenant queries, maintenance requests, and viewing bookings. Landlords love the automated paper trail.</p>
                    </div>
                  </div>
                </div>
              </div>
