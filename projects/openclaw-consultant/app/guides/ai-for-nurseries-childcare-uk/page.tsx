...
export const metadata: Metadata = {
  title: "AI for Nurseries and Childcare UK: Safe Operational Use Cases",
  description: "How UK nurseries and childcare providers can use AI for enquiries, waiting lists, parent communication, admin, and internal workflow support while keeping safeguarding central.",
  keywords: [
    "ai for nurseries childcare uk",
    "ai for nurseries and childcare uk: safe operational use cases",
    "openclaw consultant uk",
    "ai consultant uk",
    "ai automation uk",
    "blue canvas"
  ],
  alternates: { canonical: "https://openclawconsultant.co.uk/guides/ai-for-nurseries-childcare-uk" },
  openGraph: {
    title: "AI for Nurseries and Childcare UK: Safe Operational Use Cases",
    description: "How UK nurseries and childcare providers can use AI for enquiries, waiting lists, parent communication, admin, and internal workflow support while keeping safeguarding central.",
    url: "https://openclawconsultant.co.uk/guides/ai-for-nurseries-childcare-uk",
    type: "article",
  },
};
...
const stats = [
  {
    value: "Safeguarding first",
    label: "Always",
  },
  {
    value: "Admin pressure",
    label: "A strong case for support tools",
  },
  {
    value: "Best fit",
    label: "Enquiries, waiting lists, drafts, summaries",
  }
];
...
export default function AIForNurseriesChildcareUKPage() {
  return (
    <>
      <section className="hero-gradient relative overflow-hidden min-h-[70vh] flex items-center grain">
        ...
        <div className="max-w-[1140px] mx-auto px-6 relative z-10 py-20">
          <div className="max-w-[780px]">
            ...
            <h1 className="font-heading text-4xl sm:text-5xl md:text-[3.2rem] font-extrabold text-white mb-6 leading-[1.05] tracking-tight">AI for Nurseries and Childcare UK</h1>
            <p className="text-white/70 text-lg md:text-xl max-w-[680px] mb-10 leading-relaxed">Nurseries and childcare providers should be extremely selective with AI. Used well, it reduces admin pressure. Used badly, it creates risk. The line matters.</p>
