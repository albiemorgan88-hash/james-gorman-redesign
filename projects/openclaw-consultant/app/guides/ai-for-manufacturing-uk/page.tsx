...
export const metadata: Metadata = {
  title: "AI in UK Manufacturing: Implementation Guide | OpenClaw",
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <div className="text-center">
                ...
                <div className="text-slate-600 text-sm">Unplanned downtime reduction</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-slate-600 text-sm">Quality defect reduction</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-slate-600 text-sm">Overall productivity increase</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-slate-600 text-sm">Energy consumption reduction</div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-r from-orange/5 to-blue/5 rounded-xl p-6 border border-orange/10">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-3">Operational Impact:</h4>
                    <ul className="space-y-2 text-slate-600 text-sm">
              ...
              <div className="bg-gradient-to-r from-blue/5 to-green-500/5 rounded-xl p-6 border border-blue/10">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-3">Quality Improvements:</h4>
                    <ul className="space-y-2 text-slate-600 text-sm">
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-slate-100">
                <div className="flex flex-wrap items-center justify-between mb-6">
                  <div>
                    ...
                    <p className="text-slate-600 text-sm">Mid-size automotive supplier with 3 UK production facilities</p>
                  </div>
                ...
                <div className="mb-6">
                  ...
                  <p className="text-slate-600 text-sm mb-4">Reducing quality defects and unplanned downtime to meet strict automotive industry standards</p>
                  
                  <h4 className="font-semibold text-slate-800 mb-2">AI Solution:</h4>
                  <p className="text-slate-600 text-sm mb-4">Implemented predictive maintenance and computer vision quality control across all production lines</p>
                </div>
                
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                  <div className="bg-green-50 rounded-lg p-3 text-center">
                    <div className="text-sm font-medium text-slate-500 mb-1">Defect Reduction</div>
                    <div className="text-green-700 font-semibold text-sm">64%</div>
                  </div>
                  <div className="bg-green-50 rounded-lg p-3 text-center">
                    <div className="text-sm font-medium text-slate-500 mb-1">Downtime Reduction</div>
                    <div className="text-green-700 font-semibold text-sm">52%</div>
                  </div>
                  <div className="bg-green-50 rounded-lg p-3 text-center">
                    <div className="text-sm font-medium text-slate-500 mb-1">OEE Improvement</div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-slate-100">
                <div className="flex flex-wrap items-center justify-between mb-6">
                  <div>
                    ...
                    <p className="text-slate-600 text-sm">Large-scale food manufacturer with distribution across UK</p>
                  </div>
                  <div className="bg-green-100 text-green-800 px-4 py-2 rounded-full font-medium">
                    670% ROI
                  </div>
                ...
                <div className="mb-6">
                  <h4 className="font-semibold text-slate-800 mb-2">Challenge:</h4>
                  <p className="text-slate-600 text-sm mb-4">Maintaining consistent quality whilst optimising production efficiency and reducing waste</p>
                  
                  <h4 className="font-semibold text-slate-800 mb-2">AI Solution:</h4>
                  <p className="text-slate-600 text-sm mb-4">AI-powered production optimisation, quality monitoring, and supply chain forecasting</p>
                </div>
                
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                  <div className="bg-green-50 rounded-lg p-3 text-center">
                    <div className="text-sm font-medium text-slate-500 mb-1">Waste Reduction</div>
                  ...
                  <div className="bg-green-50 rounded-lg p-3 text-center">
                    <div className="text-sm font-medium text-slate-500 mb-1">Energy Savings</div>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="border-l-4 border-orange pl-4">
                      ...
                      <p className="text-slate-600 text-sm">Clean, comprehensive operational data is essential for accurate AI insights and predictions</p>
                    </div>
                    <div className="border-l-4 border-blue pl-4">
                      <h4 className="font-medium text-slate-800 mb-1">Workforce Integration</h4>
                      <p className="text-slate-600 text-sm">Training and change management ensure successful adoption and operational buy-in</p>
                    </div>
                    <div className="border-l-4 border-green-500 pl-4">
                      <h4 className="font-medium text-slate-800 mb-1">Scalable Infrastructure</h4>
                      <p className="text-slate-600 text-sm">Robust IT systems and connectivity support growing AI applications</p>
                    </div>
                    <div className="border-l-4 border-purple pl-4">
                      <h4 className="font-medium text-slate-800 mb-1">Continuous Improvement</h4>
                      <p className="text-slate-600 text-sm">Regular optimisation and system refinement drive ongoing value</p>
                    </div>
                  </div>
                </div>
              </div>
