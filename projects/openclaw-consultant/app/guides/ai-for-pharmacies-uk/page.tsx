...
export const metadata: Metadata = {
  title: "AI for Pharmacies UK: Practical Use Cases Without the Hype",
  description: "How UK pharmacies can use AI for admin, triage, documentation, stock support, and patient communication while keeping clinical judgement and governance in place.",
  keywords: [
    "ai for pharmacies uk",
    "ai for pharmacies uk: practical use cases without the hype",
    "openclaw consultant uk",
    "ai consultant uk",
    "ai automation uk",
    "blue canvas"
  ],
  alternates: { canonical: "https://openclawconsultant.co.uk/guides/ai-for-pharmacies-uk" },
  openGraph: {
    title: "AI for Pharmacies UK: Practical Use Cases Without the Hype",
    description: "How UK pharmacies can use AI for admin, triage, documentation, stock support, and patient communication while keeping clinical judgement and governance in place.",
    url: "https://openclawconsultant.co.uk/guides/ai-for-pharmacies-uk",
    type: "article",
  },
};
...
const stats = [
  {
    value: "Admin heavy",
    label: "Strong case for workflow support",
  },
  {
    value: "Clinical review stays",
    label: "Non-negotiable",
  },
  {
    value: "Best wins",
    label: "Queries, summaries, reminders, knowledge support",
  }
];
...
export default function AIForPharmaciesUKPage() {
  return (
    <>
      <section className="hero-gradient relative overflow-hidden min-h-[70vh] flex items-center grain">
        ...
        <div className="max-w-[1140px] mx-auto px-6 relative z-10 py-20">
          <div className="max-w-[780px]">
            ...
            <h1 className="font-heading text-4xl sm:text-5xl md:text-[3.2rem] font-extrabold text-white mb-6 leading-[1.05] tracking-tight">AI for Pharmacies UK</h1>
            <p className="text-white/70 text-lg md:text-xl max-w-[680px] mb-10 leading-relaxed">Pharmacies are under pressure from staffing strain, admin load, and patient demand. AI can help, but only when the boundaries are clear and clinical judgement stays where it belongs.</p>
