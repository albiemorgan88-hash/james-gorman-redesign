...
export const metadata: Metadata = {
  title: "How to Set Up an AI Agent for Your Business | Step-by-Step Guide 2026",
        ...
        <div className="max-w-[1140px] mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {platformComparison.map((platform) => (
              <div key={platform.solution} className="bg-surface rounded-box p-8 card-lift">
        ...
        <div className="max-w-[1140px] mx-auto px-6 relative z-10">
          ...
          <div className="space-y-8">
            {integrationAreas.map((area) => (
              <div key={area.category} className="bg-white/[0.03] border border-white/[0.06] rounded-box p-8">
