          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <div className="text-center">
                ...
                <div className="text-muted-dark text-sm">Cost reduction with AI</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-muted-dark text-sm">ICO fines in 2025</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-muted-dark text-sm">Continuous monitoring</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-muted-dark text-sm">Faster audit preparation</div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-r from-orange/5 to-blue/5 rounded-xl p-6 border border-orange/10">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-semibold text-dark mb-2 text-sm">What AI Automates:</h4>
              ...
              <div className="bg-gradient-to-r from-blue/5 to-green-500/5 rounded-xl p-6 border border-blue/10">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-semibold text-dark mb-2 text-sm">AI-Powered Safety:</h4>
                    <ul className="space-y-1 text-muted-dark text-xs">
                  ...
                  <div>
                    <h4 className="font-semibold text-dark mb-2 text-sm">Compliance Benefits:</h4>
                    <ul className="space-y-1 text-muted-dark text-xs">
              ...
              <div className="bg-gradient-to-r from-green-500/5 to-purple/5 rounded-xl p-6 border border-green-500/10">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-semibold text-dark mb-2 text-sm">AML Automation:</h4>
                    <ul className="space-y-1 text-muted-dark text-xs">
              ...
              <div className="bg-gradient-to-r from-purple/5 to-orange/5 rounded-xl p-6 border border-purple/10">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-semibold text-dark mb-2 text-sm">Sector Examples:</h4>
                    <ul className="space-y-1 text-muted-dark text-xs">
                  ...
                  <div>
                    <h4 className="font-semibold text-dark mb-2 text-sm">Cross-Sector Benefits:</h4>
                    <ul className="space-y-1 text-muted-dark text-xs">
          ...
          <section className="mb-16">
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b">
                      <th className="text-left py-3 font-medium text-dark">Compliance Area</th>
            ...
            <div className="bg-gradient-to-br from-orange/5 to-blue/5 rounded-xl p-8 border border-orange/10">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h4 className="font-semibold text-dark mb-3">Penalty Avoidance:</h4>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="border-l-4 border-orange pl-4">
                      <h4 className="font-medium text-dark mb-1">Compliance AI Strategy</h4>
                      <p className="text-muted-dark text-sm"><a href="https://bluecanvas.ai" className="text-orange hover:text-orange-hover">Blue Canvas</a> helps UK businesses implement AI compliance automation — from GDPR to industry-specific regulations. We map your obligations and build the monitoring you need.</p>
                    </div>
                    <div className="border-l-4 border-blue pl-4">
                      <h4 className="font-medium text-dark mb-1">Agent-Powered Compliance</h4>
                      <p className="text-muted-dark text-sm">See how AI agent teams handle compliance workflows on <a href="https://clawroster.io" className="text-orange hover:text-orange-hover">ClawRoster</a> — from automated monitoring to intelligent alerting.</p>
                    </div>
                    <div className="border-l-4 border-green-500 pl-4">
                      <h4 className="font-medium text-dark mb-1">Notification Automation</h4>
                      <p className="text-muted-dark text-sm">Use <a href="https://heypinchy.com" className="text-orange hover:text-orange-hover">Pinchy</a> to automate compliance notifications, approval workflows, and escalation chains via WhatsApp and email.</p>
                    </div>
                  </div>
                </div>
              </div>
