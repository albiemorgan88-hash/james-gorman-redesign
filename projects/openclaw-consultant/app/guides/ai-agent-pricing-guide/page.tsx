...
export const metadata: Metadata = {
  title: "AI Agent Pricing: What Does It Cost to Run an AI Agent?",
  description: "A practical guide to AI agent pricing, covering build costs, hosting, API usage, maintenance, ROI, and how to budget for a real business deployment.",
  keywords: [
  "ai agent pricing",
  "ai agent cost",
  "cost to run ai agent",
  ...
  alternates: { canonical: "https://openclawconsultant.co.uk/guides/ai-agent-pricing-guide" },
  openGraph: {
    title: "AI Agent Pricing: What Does It Cost to Run an AI Agent?",
    description: "A practical guide to AI agent pricing, covering build costs, hosting, API usage, maintenance, ROI, and how to budget for a real business deployment.",
    url: "https://openclawconsultant.co.uk/guides/ai-agent-pricing-guide",
    type: "article",
  },
};
...
const stats = [
  {
    "value": "£50-£500",
    "label": "Typical monthly run cost for modest workflows"
  },
  {
    "value": "£2k-£15k+",
    "label": "Common setup range depending on complexity"
  },
  {
    "value": "ROI",
    "label": "Matters more than raw monthly spend"
  }
];
...
const sections = [
  {
    "id": "costs",
    "title": "Four layers of AI agent cost",
    "intro": "When people ask what an AI agent costs, they usually bundle everything together. In practice there are four separate lines to understand: implementation, infrastructure, model usage, and ongoing support.",
    "cards": [
      {
  ...
  {
    "id": "roi",
    "title": "Why ROI beats sticker price",
    "intro": "A business should not ask whether an AI agent costs £100 or £500 per month in isolation. It should ask what manual time, delays, errors, and missed opportunities that spend replaces.",
    "cards": [
      {
        "heading": "Simple ROI thinking",
        "bullets": [
  ...
  {
    "id": "examples",
    "title": "Example budget ranges",
    "intro": "These are broad examples rather than fixed quotes, but they help businesses budget realistically.",
    "cards": [
      {
        "heading": "Entry-level internal agent",
        "bullets": [
      ...
      {
        "heading": "Mid-range business agent",
        "bullets": [
      ...
      {
        "heading": "Enterprise-grade deployment",
        "bullets": [
  ...
  {
    "id": "budget",
    "title": "How to budget sensibly",
    "intro": "Budget for a pilot first, not a grand transformation. Pick one recurring process with visible pain, define how success will be measured, and calculate whether the agent is cheaper than continuing to run the process manually.",
    "cards": [
      {
        "heading": "Practical budgeting tips",
        "bullets": [
      ...
      {
        "heading": "Questions to ask suppliers",
        "bullets": [
...
const faqs = [
  {
    "question": "What is the cheapest way to run an AI agent?",
    "answer": "Usually a tightly scoped workflow with limited integrations and efficient prompts, often on a self-hosted or modest cloud setup."
  },
  {
    "question": "Why do two AI agent quotes vary so much?",
    "answer": "Because one may include real workflow design, safety, and support while another is only a thin wrapper around a model. Scope matters."
  },
  {
    "question": "Does OpenClaw reduce cost?",
    "answer": "It can, particularly where you want one flexible platform for multiple workflows instead of buying separate tools for every function."
  },
  {
    "question": "Should we build our own to save money?",
    "answer": "Sometimes, but internal build costs are often underestimated. The right choice depends on technical capability, speed requirements, and the strategic value of owning the stack."
  }
];
...
const relatedGuides = [
  ...
  {
    "href": "/guides/ai-agents-roi-guide",
    "title": "AI Agents ROI Guide"
  },
  {
    "href": "/guides/building-ai-agent-team",
    "title": "Building an AI Agent Team"
  }
];

export default function AIAgentPricingGuidePage() {
  return (
    <>
        ...
        <div className="max-w-[1140px] mx-auto px-6 relative z-10 py-20">
          <div className="max-w-[760px]">
            <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-4 py-1.5 mb-8">
              ...
              <span className="text-white/60 text-sm font-medium">Pricing Guide</span>
            </div>
