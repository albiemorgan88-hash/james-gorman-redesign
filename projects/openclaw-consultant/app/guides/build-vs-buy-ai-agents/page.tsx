...
export const metadata: Metadata = {
  title: "Build vs Buy AI Agents: Making the Right Choice",
  description: "Should you build your own AI agent, buy a platform, or work with a consultant? Here is a practical decision framework for UK businesses.",
  keywords: [
  "build vs buy ai agents",
  "should we build ai agent",
  "buy ai agent platform",
  "ai consultant vs platform",
  "openclaw consultant uk",
  "ai agent build decision",
  "business automation strategy",
  "agent platform comparison"
],
  alternates: { canonical: "https://openclawconsultant.co.uk/guides/build-vs-buy-ai-agents" },
  openGraph: {
    title: "Build vs Buy AI Agents: Making the Right Choice",
    description: "Should you build your own AI agent, buy a platform, or work with a consultant? Here is a practical decision framework for UK businesses.",
    url: "https://openclawconsultant.co.uk/guides/build-vs-buy-ai-agents",
    type: "article",
  },
};
...
const stats = [
  {
    "value": "DIY",
    "label": "More control, more responsibility"
  },
  {
    "value": "Buy",
    "label": "Faster launch, less flexibility"
  },
  {
    "value": "Consultant",
    "label": "Useful when you need outcomes quickly"
  }
];
...
const sections = [
  {
    "id": "framework",
    "title": "The three main routes",
    "intro": "Most businesses end up choosing between three paths: building in-house, buying a platform, or working with a consultant who designs and deploys the solution around your process.",
    "cards": [
      {
  ...
  },
  {
    ...
    "intro": "The honest decision is not about ego. It is about where your business gets the fastest and safest return. Plenty of companies say they will build internally, then stall because no one has time to own the operational detail.",
    "cards": [
      {
        "heading": "Choose build when",
        "bullets": [
      ...
      {
        "heading": "Choose consultant when",
        "bullets": [
  ...
  {
    "id": "cost",
    "title": "Total cost is not just software",
    "intro": "The biggest error in build versus buy decisions is ignoring internal labour. A “cheap” in-house build can be very expensive if it distracts the team or drifts for six months without producing value.",
    "cards": [
      {
        "heading": "Hidden build costs",
        "bullets": [
          "Engineering time.",
  ...
  {
    "id": "next",
    "title": "Recommended approach for most SMEs",
    "intro": "For most SMEs, the best move is neither a pure DIY build nor a blind platform purchase. It is a narrow pilot around one workflow, delivered quickly, with the option to expand or internalise later.",
    "cards": [
      {
        "heading": "Pilot structure",
        "bullets": [
...
const faqs = [
  {
    "question": "Is building our own AI agent always better?",
    "answer": "No. It is only better when the strategic value and internal capability justify the slower, heavier route."
  },
  {
    "question": "Are platforms too limited?",
    "answer": "Some are, some are not. The question is whether the platform fits your workflow well enough without excessive compromise."
  },
  {
    "question": "What role does OpenClaw play here?",
    "answer": "OpenClaw can be the platform itself, or the foundation for a consultant-led deployment where you want flexibility and broader automation coverage."
  },
  {
    "question": "Can we start with a consultant and bring it in-house later?",
    "answer": "Yes, and that is often a sensible path if ownership matters eventually but speed matters now."
  }
];
...
const relatedGuides = [
  ...
  {
    "href": "/guides/ai-agent-cost-uk",
    "title": "AI Agent Cost UK"
  }
];

export default function BuildVsBuyAIAgentsPage() {
  return (
    <>
        ...
        <div className="max-w-[1140px] mx-auto px-6 relative z-10 py-20">
          <div className="max-w-[760px]">
            <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-4 py-1.5 mb-8">
              ...
              <span className="text-white/60 text-sm font-medium">Strategy Guide</span>
            </div>
