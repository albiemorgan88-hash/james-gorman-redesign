...
export const metadata: Metadata = {
  title: "AI Agents for Hair Salons & Spas: Automate Booking & Client Management | UK Beauty AI",
      ...
      <section className="bg-light py-16">
        <div className="max-w-[1140px] mx-auto px-6 text-center">
          ...
          <p className="text-muted max-w-[600px] mx-auto text-sm">
            Phil Patterson helps UK hair salons and spas implement AI automation from his base in Derry, Northern Ireland. 
