...
export const metadata: Metadata = {
  title: "AI for Plumbers and Trade Businesses: Automate Bookings, Quotes, and Admin | OpenClaw",
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <div className="text-center">
                ...
                <div className="text-slate-600 text-sm">Weekly admin time</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-slate-600 text-sm">Calls missed on-site</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-slate-600 text-sm">Lost revenue from missed leads</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-slate-600 text-sm">Average invoice payment time</div>
              </div>
            </div>
          ...
          <section className="mb-16">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-green-500/5 to-purple/5 rounded-xl p-6 border border-green-500/10">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-2 text-sm">Automation:</h4>
                    <ul className="space-y-1 text-slate-600 text-xs">
                  ...
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-2 text-sm">Cash Flow Results:</h4>
                    <ul className="space-y-1 text-slate-600 text-xs">
          ...
          <section className="mb-16">
            ...
            <div className="bg-gradient-to-br from-orange/5 to-blue/5 rounded-xl p-8 border border-orange/10">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h4 className="font-semibold text-slate-800 mb-3">Sole Traders:</h4>
                ...
                <div>
                  <h4 className="font-semibold text-slate-800 mb-3">Teams (3-10 people):</h4>
                  <ul className="space-y-2 text-slate-600 text-sm">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="border-l-4 border-orange pl-4">
                      <h4 className="font-medium text-slate-800 mb-1">AI for Trade Businesses</h4>
                      <p className="text-slate-600 text-sm"><a href="https://bluecanvas.ai" className="text-orange hover:text-orange-hover">Blue Canvas</a> specialises in setting up AI automation for trade businesses across the UK — from sole traders to 20-person teams.</p>
                    </div>
                    <div className="border-l-4 border-blue pl-4">
                      <h4 className="font-medium text-slate-800 mb-1">WhatsApp Automation</h4>
                      <p className="text-slate-600 text-sm">Automate customer communication on WhatsApp with <a href="https://heypinchy.com" className="text-orange hover:text-orange-hover">Pinchy</a> — send quotes, confirmations, and updates without lifting a finger.</p>
                    </div>
                    <div className="border-l-4 border-green-500 pl-4">
                      <h4 className="font-medium text-slate-800 mb-1">Trade Career Resources</h4>
                      <p className="text-slate-600 text-sm">Growing your team? <a href="https://uktradejobs.com" className="text-orange hover:text-orange-hover">UK Trade Jobs</a> has salary guides, apprenticeship info, and career pathways for every trade.</p>
                    </div>
                  </div>
                </div>
              </div>
