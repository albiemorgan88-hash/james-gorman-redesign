...
export const metadata: Metadata = {
  title: "AI for Car Dealerships UK: Sales, Service, and Follow-Up Workflows",
  description: "How UK car dealerships can use AI for lead handling, service reminders, valuation follow-up, document admin, and smoother customer communication.",
  keywords: [
    "ai for car dealerships uk",
    "ai for car dealerships uk: sales, service, and follow-up workflows",
    "openclaw consultant uk",
    "ai consultant uk",
    "ai automation uk",
    "blue canvas"
  ],
  alternates: { canonical: "https://openclawconsultant.co.uk/guides/ai-for-car-dealerships-uk" },
  openGraph: {
    title: "AI for Car Dealerships UK: Sales, Service, and Follow-Up Workflows",
    description: "How UK car dealerships can use AI for lead handling, service reminders, valuation follow-up, document admin, and smoother customer communication.",
    url: "https://openclawconsultant.co.uk/guides/ai-for-car-dealerships-uk",
    type: "article",
  },
};
...
const stats = [
  {
    value: "Lead speed matters",
    label: "Response time drives revenue",
  },
  {
    value: "Service load",
    label: "Reminder and admin workflows add up",
  },
  {
    value: "Human sales still wins",
    label: "AI should support, not replace",
  }
];
...
export default function AIForCarDealershipsUKPage() {
  return (
    <>
      <section className="hero-gradient relative overflow-hidden min-h-[70vh] flex items-center grain">
        ...
        <div className="max-w-[1140px] mx-auto px-6 relative z-10 py-20">
          <div className="max-w-[780px]">
            ...
            <h1 className="font-heading text-4xl sm:text-5xl md:text-[3.2rem] font-extrabold text-white mb-6 leading-[1.05] tracking-tight">AI for Car Dealerships UK</h1>
            <p className="text-white/70 text-lg md:text-xl max-w-[680px] mb-10 leading-relaxed">Dealerships lose money in the gaps between enquiry, response, valuation, finance admin, and service follow-up. AI helps most when it closes those gaps fast.</p>
