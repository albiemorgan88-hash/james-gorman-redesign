...
export const metadata: Metadata = {
  title: "AI Invoice Processing: Cut Admin Time by 80% | OpenClaw",
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <div className="text-center">
                ...
                <div className="text-slate-600 text-sm">Processing time reduction</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-slate-600 text-sm">Data extraction accuracy</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-slate-600 text-sm">Straight-through processing</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-slate-600 text-sm">Average annual savings</div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-r from-orange/5 to-blue/5 rounded-xl p-6 border border-orange/10">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-3">Processing Benefits:</h4>
                    <ul className="space-y-2 text-slate-600 text-sm">
              ...
              <div className="bg-gradient-to-r from-blue/5 to-green-500/5 rounded-xl p-6 border border-blue/10">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-3">Workflow Intelligence:</h4>
                    <ul className="space-y-2 text-slate-600 text-sm">
                  ...
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-3">Approval Efficiency:</h4>
                    <ul className="space-y-2 text-slate-600 text-sm">
              ...
              <div className="bg-gradient-to-r from-green-500/5 to-purple/5 rounded-xl p-6 border border-green-500/10">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <h4 className="font-semibold text-slate-800 mb-3">Risk Mitigation:</h4>
                    <ul className="space-y-2 text-slate-600 text-sm">
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-slate-100">
                <div className="flex flex-wrap items-center justify-between mb-6">
                  <div>
                    ...
                    <p className="text-slate-600 text-sm">Mid-sized manufacturer processing 2,000+ invoices monthly</p>
                  </div>
                ...
                <div className="mb-6">
                  ...
                  <p className="text-slate-600 text-sm mb-4">Manual processing of complex supplier invoices causing payment delays, approval bottlenecks, and data entry errors</p>
                  
                  <h4 className="font-semibold text-slate-800 mb-2">AI Solution:</h4>
                  <p className="text-slate-600 text-sm mb-4">Implemented intelligent OCR, automated 3-way matching, and smart approval workflows with mobile access</p>
                </div>
                
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                  <div className="bg-green-50 rounded-lg p-3 text-center">
                    <div className="text-sm font-medium text-slate-500 mb-1">Processing Time</div>
                    <div className="text-green-700 font-semibold text-sm">From 5 to 1 day</div>
                  </div>
                  <div className="bg-green-50 rounded-lg p-3 text-center">
                    <div className="text-sm font-medium text-slate-500 mb-1">Data Accuracy</div>
                    <div className="text-green-700 font-semibold text-sm">98.5%</div>
                  </div>
                  <div className="bg-green-50 rounded-lg p-3 text-center">
                    <div className="text-sm font-medium text-slate-500 mb-1">Staff Time Saved</div>
                    <div className="text-green-700 font-semibold text-sm">160 hrs/month</div>
                  </div>
                  <div className="bg-green-50 rounded-lg p-3 text-center">
                    <div className="text-sm font-medium text-slate-500 mb-1">Early Payment Discounts</div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-slate-100">
                <div className="flex flex-wrap items-center justify-between mb-6">
                  <div>
                    ...
                    <p className="text-slate-600 text-sm">Legal practice with multiple offices processing varied supplier invoices</p>
                  </div>
                  <div className="bg-green-100 text-green-800 px-4 py-2 rounded-full font-medium">
                    380% ROI
                  </div>
                ...
                <div className="mb-6">
                  <h4 className="font-semibold text-slate-800 mb-2">Challenge:</h4>
                  <p className="text-slate-600 text-sm mb-4">Diverse invoice formats, multiple approval hierarchies, and partner-level approval requirements creating processing delays</p>
                  
                  <h4 className="font-semibold text-slate-8000 mb-2">AI Solution:</h4>
                  <p className="text-slate-600 text-sm mb-4">AI-powered multi-format processing with intelligent routing and mobile approval capabilities</p>
                </div>
                
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                  <div className="bg-green-50 rounded-lg p-3 text-center">
                    <div className="text-sm font-medium text-slate-500 mb-1">Approval Speed</div>
                    <div className="text-green-700 font-semibold text-sm">78% faster</div>
                  </div>
                  <div className="bg-green-50 rounded-lg p-3 text-center">
                    <div className="text-sm font-medium text-slate-500 mb-1">Processing Errors</div>
                    <div className="text-green-700 font-semibold text-sm">-89%</div>
                  </div>
                  <div className="bg-green-50 rounded-lg p-3 text-center">
                    <div className="text-sm font-medium text-slate-500 mb-1">Late Payment Fees</div>
                    <div className="text-green-700 font-semibold text-sm">Eliminated</div>
                  </div>
                  <div className="bg-green-50 rounded-lg p-3 text-center">
                    <div className="text-sm font-medium text-slate-500 mb-1">Partner Satisfaction</div>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="border-l-4 border-orange pl-4">
                      <h4 className="font-medium text-slate-800 mb-1">Clean Data Integration</h4>
                      <p className="text-slate-600 text-sm">Seamless connection with ERP and accounting systems is crucial</p>
                    </div>
                    <div className="border-l-4 border-blue pl-4">
                      <h4 className="font-medium text-slate-800 mb-1">Change Management</h4>
                      <p className="text-slate-600 text-sm">Staff training and gradual rollout ensure smooth adoption</p>
                    </div>
                    <div className="border-l-4 border-green-500 pl-4">
                      <h4 className="font-medium text-slate-800 mb-1">Exception Handling</h4>
                      <p className="text-slate-600 text-sm">Clear processes for unusual invoices maintain efficiency</p>
                    </div>
                    <div className="border-l-4 border-purple pl-4">
                      <h4 className="font-medium text-slate-800 mb-1">Continuous Improvement</h4>
                      <p className="text-slate-600 text-sm">Regular system tuning optimises accuracy and performance</p>
                    </div>
                  </div>
                </div>
              </div>
