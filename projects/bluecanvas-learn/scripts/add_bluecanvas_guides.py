...
file = Path('/Users/philsagent/.openclaw/workspace/projects/bluecanvas-learn/lib/guides.ts')
src = file.read_text()
...
if any(f"slug: '{slug}'" in src for slug in slugs):
    raise SystemExit('One or more target guides already exist. Aborting.')
...
src = src.rstrip()[:-2] + addition + '\n];\n'
file.write_text(src)
print('Added 8 guide entries.')
