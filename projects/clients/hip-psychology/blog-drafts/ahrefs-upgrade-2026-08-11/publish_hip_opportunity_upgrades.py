...
def headers() -> dict[str, str]:
    ...
    return {"Authorization": "Basic " + base64.b64encode(raw).decode(), "User-Agent": "HIP-SEO-Opportunity-Upgrades-2026-08-11"}
...
def checks_for(markup: str, live: bool = False) -> dict[str, bool]:
    ...
    checks = {
        "h2_sections": len(re.findall(r"<h2\b", markup, re.I)) >= 10,
...
lines = ["# HIP Psychology SEO opportunity upgrade — 11 August 2026", "", "Status: Six existing ranking URLs updated live after explicit approval.", "", "## Updated pages"]
