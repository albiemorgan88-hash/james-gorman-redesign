...
PUBLISH_REPORT = BASE / "blog-publish-report-2026-08-14-transaction-guides.json"
REPORT_JSON = BASE / "gsc-indexing-2026-08-14-transaction-guides.json"
REPORT_MD = BASE / "gsc-indexing-2026-08-14-transaction-guides.md"
...
def main() -> int:
    ...
    lines = [
        "# GSC indexing - James Gorman transaction guide release - 14 August 2026",
        "",
        f"- Property: `{gsc.SITE}`",
