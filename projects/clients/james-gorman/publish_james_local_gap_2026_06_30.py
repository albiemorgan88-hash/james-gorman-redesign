...
PACK_DIR = BASE / "content-blast-2026-06-30-local-gap"
MANIFEST = PACK_DIR / "manifest.json"
DRAFT_PACK = PACK_DIR / "content-blast-2026-06-30-local-gap-draft-pack.md"
REPORT_JSON = BASE / "blog-publish-report-2026-06-30-local-gap.json"
QA_JSON = BASE / "blog-publish-api-qa-2026-06-30-local-gap.json"
REPORT_MD = BASE / "blog-publish-report-2026-06-30-local-gap.md"
SITE = "https://www.jamesgormanproperty.com"

SOURCE_NOTE = (
    "Published after Phil explicitly approved the 30 June local-gap James Gorman content pack. "
    "The batch avoids direct overlap with the 23 June BT47/BT48/Londonderry/Prehen/Creggan/"
    "Magheramason/Greysteel blast and focuses on Rosemount, Shantallow, Pennyburn, Bogside, "
    "Woodbrook, Ardmore and terrace-house seller intent."
)
...
def write_md_report(report: dict, qa: dict) -> None:
    lines = [
        "# James Gorman local gap content blast publish report - 2026-06-30",
        "",
        SOURCE_NOTE,
        "",
        "## Published URLs",
