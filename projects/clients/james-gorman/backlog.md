...
- [TODO] Draft remediation plan for **mobile performance issues** on key pages.
...
- [TODO] Draft schema implementation notes for `RealEstateAgent` / `LocalBusiness` / `Organization`.
...
- [IN PROGRESS] First local content/page strategy drafted for Derry / Limavady / Eglinton / Dungiven.
- [TODO] Draft first 4 location pages from the strategy.
...
- [TODO] Pull first Ahrefs-backed weekly metrics snapshot once access is confirmed.
...
2. Draft the first two location pages: `estate-agent-limavady` and `estate-agent-eglinton`.
3. Draft GBP setup pack and citation shortlist.
4. Confirm Ahrefs/GSC/GA4 access for Friday reporting quality.
5. Enable/verify Wix Blog, create the recommended categories, and publish `blog-01-draft-2026-03-12.md` first.
