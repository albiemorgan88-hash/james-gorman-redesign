...
REPORT_JSON = BASE / "gsc-indexing-2026-07-09-north-cityside-gap.json"
REPORT_MD = BASE / "gsc-indexing-2026-07-09-north-cityside-gap.md"
PUBLISH_REPORT = BASE / "blog-publish-report-2026-07-09-north-cityside-gap.json"
...
def main():
    ...
    lines = [
        "# GSC Indexing - James Gorman North/Cityside Gap Blast - 9 July 2026",
        "",
        f"- Property: `{SITE}`",
