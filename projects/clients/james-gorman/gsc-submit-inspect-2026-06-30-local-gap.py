...
REPORT_JSON = BASE / 'gsc-indexing-2026-06-30-local-gap.json'
REPORT_MD = BASE / 'gsc-indexing-2026-06-30-local-gap.md'
PUBLISH_REPORT = BASE / 'blog-publish-report-2026-06-30-local-gap.json'
...
def main():
    ...
    lines = [
        '# GSC Indexing - James Gorman Local Gap Blast - 30 June 2026',
        '',
        f"- Property: `{SITE}`",
