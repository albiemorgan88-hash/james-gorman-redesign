...
# Categories more likely to have mobile numbers and no websites (smaller/newer businesses)
CATEGORIES = [
    "mobile hairdresser", "mobile barber", "mobile beauty therapist",
    "dog groomer", "mobile dog grooming", "pet sitting", 
    "personal trainer", "mobile massage therapist",
    "wedding photographer", "event photographer", "freelance photographer",
    "mobile car wash", "car detailing", "mobile valeting",
    "gardening service", "landscaping", "tree surgeon",
    "handyman", "painter decorator", "tiling contractor",
    "mobile mechanic", "MOT testing", 
    "taxi service", "private hire",
    "catering service", "mobile catering",
    "cleaning service", "domestic cleaning",
    "chilminder", "babysitting service",
    "music teacher", "driving instructor",
    "wedding cake maker", "baker"
]
...
def has_real_website(website):
    ...
    facebook_domains = ['facebook.com', 'fb.com', 'm.facebook.com', 'instagram.com', 'justdial.com']
...
def main():
    ...
    print(f"🔍 Starting Belfast mobile business search...")
    print(f"📊 Searching {len(CATEGORIES)} categories across {len(LOCATIONS)} locations")
    print(f"🎯 Target: Businesses with mobile numbers and no real websites\n")
    ...
    if len(all_businesses) == 0:
        print("⚠️  No qualifying businesses found.")
        print("💡 Try searching for more categories or different locations.")
        return
