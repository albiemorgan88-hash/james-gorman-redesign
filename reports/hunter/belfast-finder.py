...
CATEGORIES = [
    ...
    "restaurant", "cafe", "pub with food", "hotel", "B&B",
...
def main():
    ...
    for location in LOCATIONS:
        for category in CATEGORIES:
            current_search += 1
            print(f"\nProgress: {current_search}/{total_searches} - Searching {category} in {location}")
            ...
            for place in places:
                ...
                print(f"✅ Added: {name} ({phone}) - {review_count} reviews")
