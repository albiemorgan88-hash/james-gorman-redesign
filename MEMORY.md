...
- **OCC / OpenClaw Consultant:** `openclawconsultant.co.uk` deploy reached `READY` on 2026-04-21 22:22 BST with alias assigned. Live checks returned `200` for `/` and `/guides/installing-pinchy`.
