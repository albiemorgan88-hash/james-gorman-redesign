...
Google Ads `801-851-4760` (billing active, campaign running)
  - Manager account: `396-378-6948`
  - API: v19, developer token (test→Basic access pending), OAuth creds in ~/.zprofile
  - Env vars: GOOGLE_ADS_ACCOUNT_ID, GOOGLE_ADS_MANAGER_ID, GOOGLE_ADS_DEVELOPER_TOKEN, GOOGLE_ADS_CLIENT_ID, GOOGLE_ADS_CLIENT_SECRET, GOOGLE_ADS_REFRESH_TOKEN
