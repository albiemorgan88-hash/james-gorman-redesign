...
description: Technical reference for all Blue Canvas infrastructure — Vercel deployments, Supabase databases, Stripe keys, domain mappings, deployment commands. Load when deploying, debugging, or managing any project infrastructure.
---
